...
console.log("solution: " + input.reduce((p,v) => calculate_fuel_const(v, median(input))+ p, 0));                                                   //solution: 37
console.log("solution: " + input.reduce((p,v) => calculate_fuel_increasing(v, Math.ceil(input.reduce((p,v) => p+v,0)/input.length)) + p, 0));      //solution: 168